...
Também existe o outro lado. A pessoa entra animada, quer ajudar, mas depois encontra conflitos, denúncias, organização e responsabilidades que não aparecem quando olhamos apenas para o cargo. Aos poucos, participa menos, perde a motivação e começa a se afastar. Até que um dia:
...
Você pode ter permissão para punir alguém e ainda não saber conversar com essa pessoa. Pode organizar uma equipe e ainda não saber ouvir ninguém. Uma liderança saudável não precisa dizer:
...
Resolver problemas, acompanhar conflitos e estar sempre disponível pode transformar algo que começou como diversão em uma obrigação. O servidor que antes era um lugar para relaxar começa a parecer mais um lugar onde sempre existe algo para resolver. Para algumas pessoas, o afastamento acaba sendo a consequência.
...
Existe uma parte da Staff que quase nunca aparece nas regras: **lidar com pessoas**. Você precisa conversar com alguém irritado, separar uma discussão, aplicar uma punição ou ouvir uma reclamação sem perder a cabeça. Moderar uma comunidade também significa lidar com emoções, inclusive as suas.
...
Outro problema é quando o trabalho da Staff se torna invisível. Quando tudo funciona, ninguém percebe. Quando algo dá errado, todos percebem. Se a pessoa sente que seu esforço nunca é reconhecido, pode começar a questionar por que continua fazendo aquilo.
